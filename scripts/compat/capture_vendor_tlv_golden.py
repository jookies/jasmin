...
def build_document() -> dict:
    ...
    cases = [
        ...
        {"id": "parse_decimal_underscores", "operation": "parse_tag", "input": {"tag_key": "1_000"}},
        {"id": "parse_hex_underscores", "operation": "parse_tag", "input": {"tag_key": "0x1_401"}},
        {"id": "parse_unicode_decimal_digits", "operation": "parse_tag", "input": {"tag_key": "１２"}},
        {"id": "parse_hex_positive_sign_errors", "operation": "parse_tag", "input": {"tag_key": "0x+1"}},
        {"id": "parse_hex_negative_sign_errors", "operation": "parse_tag", "input": {"tag_key": "0x-1"}},
        ...
        {"id": "resolve_integer_underscores", "operation": "resolve", "input": {"tlvs": [tlv(0x1401, "string", "1_000")], "rules": [rule(0x1401, "Int8")]}},
        {"id": "resolve_hex_positive_sign_errors", "operation": "resolve", "input": {"tlvs": [tlv(0x1401, "string", "0x+1")], "rules": [rule(0x1401, "Int8")]}},
        {"id": "resolve_hex_negative_sign_errors", "operation": "resolve", "input": {"tlvs": [tlv(0x1401, "string", "0x-1")], "rules": [rule(0x1401, "Int8")]}},
        ...
        {"id": "encode_octet_arbitrary_precision_integer", "operation": "encode_value", "input": {"type": "OctetString", "value": value("int", "18446744073709551616")}},
        {"id": "encode_coctet_negative_arbitrary_precision_integer", "operation": "encode_value", "input": {"type": "COctetString", "value": value("int", "-18446744073709551617")}},
        {"id": "encode_untyped_arbitrary_precision_integer", "operation": "encode_value", "input": {"type": None, "value": value("int", "18446744073709551616")}},
        {"id": "encode_int1_overflow_errors", "operation": "encode_value", "input": {"type": "Int1", "value": value("int", "256")}},
        {"id": "encode_int8_negative_errors", "operation": "encode_value", "input": {"type": "Int8", "value": value("int", "-1")}},
        {"id": "encode_int8_overflow_errors", "operation": "encode_value", "input": {"type": "Int8", "value": value("int", "18446744073709551616")}},
