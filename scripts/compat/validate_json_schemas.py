...
PAIRS = {
    ...
    "vendor-tlv": (
        ROOT / "compat/fixtures/schema/vendor-tlv-golden.schema.json",
        ROOT / "compat/fixtures/vendor-tlv/baseline.json",
    ),
    "smpp-client-pacing": (
    ...
    "billing-persistence": (
        ROOT / "compat/fixtures/schema/billing-persistence-golden.schema.json",
        ROOT / "compat/fixtures/billing-persistence/baseline.json",
    ),
