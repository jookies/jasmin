...
class deliverSmThrowerConfig(ConfigFile):
    ...
    def __init__(self, config_file = None):
        ...
        self.retryDelay = self._getint('deliversm-thrower', 'http_retry_delay', 30)
        self.maxRetries = self._getint('deliversm-thrower', 'http_max_retries', 3)
...
class DLRThrowerConfig(ConfigFile):
    ...
    def __init__(self, config_file = None):
        ...
        self.retry_delay = self._getint('dlr-thrower', 'http_retry_delay', 30)
        self.max_retries = self._getint('dlr-thrower', 'http_max_retries', 3)
