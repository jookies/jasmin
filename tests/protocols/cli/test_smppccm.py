...
class BasicTestCases(HappySMSCTestCase):
    ...
    def test_add_and_show(self):
        ...
        expectedList = [
            ...
            r'host 127.0.0.1',
            r'port 2775',
            r'username smppclient',
            r'logrotate midnight',
            r'password password',
            r'systype ',
            r'logfile .*var/log/jasmin[/]+default-%s.log' % cid,
            r'loglevel 20',
            r'logprivacy no',
            r'bind_to 30',
            r'elink_interval 30',
            r'res_to 120',
            r'con_loss_retry yes',
            r'bind_npi 0',
            r'con_loss_delay 10',
            r'con_fail_delay 10',
            r'pdu_red_to 10',
            ...
            r'coding 0',
            r'requeue_delay 120',
            r'submit_throughput 1',
            r'dlr_expiry 86400',
            r'dlr_msgid 0',
            r'con_fail_retry yes',
            r'dst_npi 1',
            r'trx_to 300',
            r'ssl no',
        ]
